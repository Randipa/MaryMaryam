...
<body>
  ...
  <header >           
    ...
    <div class="navi" >  
        ...
        <div class="shopName" >
            <a href="/MaryMaryam/MaryMaryam/mary.html"  aria-label="Home" title="Home"> <img src="Frame1.png" alt=""></a>   
        </div>
        ...
        <div class="nav-content">
            ...
            <li  class="navTitle"><a href="#">Our Story</a></li>
        </ul>
...
<div class="row">
  ...
  <div class="col-50">
  <h3 id="billTit">Add You Need Ite</h3>
        <!-- Add a field for item names -->
       <input type="text" id="item_names" name="item_names" placeholder="Item Names">
    <h3 id="billTit">Billing Address</h3>
    <label for="fname" id="perInfo" class="labels"><i class="fa fa-user"></i> Personal </label>
    <input type="text" id="fname" name="name"
           placeholder="Contact name">

    <!-- Add a field for item names -->
    <input type="text" id="phone" name="phone" placeholder="phoneNo">       
    <!-- <label for="email"><i class="fa fa-envelope"></i> Email</label> -->
    <input type="text" id="email" name="email" placeholder="Email">
    <label for="adr" id="addr" class="labels"><i class="fa fa-address-card-o"></i> Address</label>
    <input type="text" id="adr" name="address" placeholder="Street, house/apartment/unit">
...
<label id="shipAdr" class="labels">
  <input type="checkbox" checked="checked" name="sameadr"> 
   Shipping address same as billing
</label>
<input type="submit" value="Save Order Details " class="btnCon" >
      ...
      <form action="#">
        ...
        <input type="submit" value="Continue to checkout" class="btnCon" onclick="paymentGatWay();">
...
<!-- <script src="\MaryMaryam\Necklaces\Necklace.js"></script>
<script src="\MaryMaryam\Rings\Rings.js"></script>
<script src="\MaryMaryam\Earings\Earring.js"></script> -->

<script>
function validateForm() {
  var itemNames = document.getElementById("item_names").value;
  ...
  if (itemNames == "" || name == "" || phone == "" || email == "" || address == "" || city == "" || state == "" || zip == "") {
...
$sql = "INSERT INTO checkout (name, email, address, city, state, zip, item_names, phone) 
        VALUES ('$name', '$email', '$address', '$city', '$state', '$zip', '$item_names', '$phone')";
